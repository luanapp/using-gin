...
func (_mock *MockRepository[T]) Delete(id string) error {
	ret := _mock.Called(id)
...
func (_c *MockRepository_Delete_Call[T]) RunAndReturn(run func(id string) error) *MockRepository_Delete_Call[T] {
	_c.Call.Return(run)
	return _c
}
...
type MockRepository_GetAll_Call[T any] struct {
	*mock.Call
}
...
func (_mock *MockRepository[T]) GetById(id string) (*T, error) {
	ret := _mock.Called(id)
...
type MockRepository_GetById_Call[T any] struct {
	*mock.Call
}
...
func (_c *MockRepository_GetById_Call[T]) Return(v *T, err error) *MockRepository_GetById_Call[T] {
	_c.Call.Return(v, err)
	return _c
}

func (_c *MockRepository_GetById_Call[T]) RunAndReturn(run func(id string) (*T, error)) *MockRepository_GetById_Call[T] {
	_c.Call.Return(run)
	return _c
}

// Save provides a mock function for the type MockRepository
func (_mock *MockRepository[T]) Save(entity *T) (*T, error) {
...
type MockRepository_Save_Call[T any] struct {
	*mock.Call
}
...
func (_c *MockRepository_Save_Call[T]) Return(v *T, err error) *MockRepository_Save_Call[T] {
	_c.Call.Return(v, err)
	return _c
}

func (_c *MockRepository_Save_Call[T]) RunAndReturn(run func(entity *T) (*T, error)) *MockRepository_Save_Call[T] {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockRepository
func (_mock *MockRepository[T]) Update(id string, entity *T) error {
	ret := _mock.Called(id, entity)
...
func (_c *MockRepository_Update_Call[T]) RunAndReturn(run func(id string, entity *T) error) *MockRepository_Update_Call[T] {
	_c.Call.Return(run)
	return _c
}
